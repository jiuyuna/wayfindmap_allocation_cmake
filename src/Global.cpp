...
vector<CPoint> available_points; //��¼�����пɵ���ĵ�?1?7
Patharc pathTable;

//��ʼ���õ�ȫ�ֵ�����ʱ����
unordered_map<string, int> hashmap;
int myMap[MAX_Height][MAX_Width] = {};
bool boolMap[MAX_Height][MAX_Width] = {false}; //���ڱ���ѱ����ĵ�?1?7
    ...
    while (getline(infile, coordstr))
    {
        ...
        else if (coordstr == "//circle_coordinate")
        {
            while (getline(infile, coordstr) && coordstr != "./")
            {
                ...
                obs.ex = obstical_lines[obstical_lines.size() - 5].sx; //Ϊ�˷�ֹ�����?������δ�պϣ����һ���߶��ֶ��պ�?
...
void init_pedestrian(string traffic_path, string timetable_path)
{
    ...
    if (saveTimeTableAndKeepSame)
    {
        ...
        else
        {
            ...
            int need_sum_people = 100;//scene1/2:100,scene3:300
...
bool isFeasible(int x, int y) {
    ...
    for (size_t i = 0; i < available_points.size(); ++i) {
        ...
        if (x == P.X && y == P.Y) return true; //�õ����?1?7
    }
    return false; //�ڱ߽���
}

//���һ����?����õ�λ���ϰ��ڻ�߽��У���Ż�һ������λ�ã���λ���?���н⡣
